...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            //                     // ПОМЕНЯЛИ: Показываем сообщение о завершении
            //                     conversionInfo.innerHTML = `
            //             <div class="file-status">
            //                 <span class="conversion-status status-completed">Conversion completed! Downloading...</span>
            //             </div>
            //         `;

            //                     // ДОБАВИЛИ: Автоматическое скачивание файла
            //                     //triggerAutoDownload(data.file, fileId, conversionInfo);
            //                     universalDownload(data.file, getDownloadFileName(conversionType));
